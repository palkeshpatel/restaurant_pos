    ...
    <div class="receipt">
        ...
        @if (!empty($billing) && isset($billing['total_bill']))
            ...
            <table>
                ...
                <tr>
                    <td>Discount</td>
                    <td style="text-align: right;">${{ number_format((float) ($billing['total_discount'] ?? 0), 2) }}
                    </td>
                </tr>
                <tr>
                    <td>Tax</td>
                ...
                <tr>
                    <td>Gratuity</td>
                    <td style="text-align: right;">${{ number_format((float) ($billing['gratuity_amount'] ?? 0), 2) }}
                    </td>
                </tr>
                <tr>
                    <td>Fees</td>
                ...
                @if ((float) ($billing['tip_amount'] ?? 0) > 0)
                    <tr>
                        <td>Tip</td>
                        <td style="text-align: right;">${{ number_format((float) ($billing['tip_amount'] ?? 0), 2) }}
                        </td>
                    </tr>
                @endif
                <tr class="total-row">
                ...
                @if (!empty($paymentHistories) && count($paymentHistories) > 0)
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <strong>${{ number_format((float) ($billing['paid_amount'] ?? 0), 2) }}</strong>
                        </td>
                    </tr>
                @elseif((float) ($billing['paid_amount'] ?? 0) > 0)
                    <tr>
                        <td>Paid</td>
                        <td style="text-align: right;">${{ number_format((float) ($billing['paid_amount'] ?? 0), 2) }}
                        </td>
                    </tr>
                @endif
                <tr>
